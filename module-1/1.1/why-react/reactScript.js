...
const firstApproach = document.createElement('p'); // element তৈরি করা হলো
...
const secondApproach = React.createElement('div', null, React.createElement('p', null, 'Hello World from React')); // react এর মাধ্যমে content সহ element তৈরি করা হলো
...
const secondApproach2 = (
    <div>
        <p>Hello</p>
    </div>
);
ReactDOM.createRoot(document.getElementById('root-3')).render(secondApproach2);
        ...
        <div className="shadow-md rounded-lg bg-slate-800 border-slate-700">
            ...
            <div className="px-5 py-5">
                ...
                <div className="flex items-center justify-between mt-5">
                    ...
                    <a href="#" onClick={addToCart} className="text-white focus:ring-4 font-medium rounded-lg text-sm px-5 py-2.5 text-center bg-[#087ea4] hover:bg-[#087ea4]/[.8] focus:ring-[#087ea4]/[.5]">
                        Add to cart
                    </a>
                </div>
            </div>
